...
Exported flows contain all 47 features used by the trained RF and AE.
(MIN_TTL and MAX_TTL removed — FIX D: TTL domain shift elimination)
"""
...
class FlowExtractor:
    ...
    def _export(self, flow: _FlowRecord) -> Optional[dict]:
        ...
        features = {
            # ── 47 model features (exact names matching FEATURE_COLS) ─────────
            # FIX D: MIN_TTL and MAX_TTL are NO LONGER included in model features.
            # TTL tracking is still performed in _FlowRecord for future analysis.
            ...
            # FIX D: MIN_TTL and MAX_TTL REMOVED from model features
            # (TTL values still tracked in _FlowRecord for diagnostics)
